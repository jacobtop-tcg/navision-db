...
def load_data(use_verified=True):
    ...
    try:
        ...
        if use_verified:
            ...
            companies_url = "https://raw.githubusercontent.com/jacobtop-tcg/navision-db/master/exports/companies-final-with-jobs.csv"
            summary_url = "https://raw.githubusercontent.com/jacobtop-tcg/navision-db/master/exports/summary-final-with-jobs.json"
            data_type = "FINAL WITH JOBS (2026-04-15)"
        else:
